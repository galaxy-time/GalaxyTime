...
val celestialBodies = arrayOf(
    ...
    CelestialBody("Earth",    6371.0,     510100000.0,  1.00,   24.0f,  5f),
    CelestialBody("Moon",     1737.4,      37900000.0,  1.00,  708.7f,  3f),
    CelestialBody("Mars",     3389.5,     144800000.0,  1.52,   24.7f,  4f),
    CelestialBody("Jupiter", 69911.0,   61420000000.0,  5.20,    9.9f, 12f),
    CelestialBody("Saturn",  58232.0,   42700000000.0,  9.58,   10.7f, 12f),
    CelestialBody("Uranus",  25362.0,    8113000000.0, 19.22,   17.2f,  8f),
    CelestialBody("Neptune", 24622.0,    7618000000.0, 30.05,   16.1f,  8f),
